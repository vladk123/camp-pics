...
describe('Mongoose 8.24.2 security upgrade', () => {
  ...
  test('production models and database behavior outside approved operational files remain unchanged', () => {
    ...
    const changed = execFileSync(
      'git',
      ['status', '--short', '--untracked-files=all', '--', ...protectedPaths],
    ...
    const allowedOperationalChanges = new Set([
      ...
      'models/upload.js',
      'public/css/adminAnnouncements.css',
      'public/css/adminDashboard.css',
      'public/css/adminRoadmap.css',
      'public/css/adminMonthlyDrawUploads.css',
      'public/css/siteAnnouncement.css',
      'public/css/adminUserDetail.css',
      'public/css/monthlyDraw.css',
      'public/css/images/marker-icon-2x-old.png',
      'public/css/images/marker-icon-old.png',
