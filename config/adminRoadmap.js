  ...
  phases: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          title: 'Restore a production-shaped staging database',
          status: 'blocked',
          purpose: 'Create an isolated staging database from a verified production-shaped backup.',
          scope: [
            'Create and verify a backup.',
            'Restore it to a temporary non-production database.',
            'Verify collections and representative record counts.',
          ...
          doneWhen: [
            'Restored staging data is available.',
            'Production remains untouched.',
            'Rollback/disposal steps are documented.',
          ],
          notes: [],
          completedOn: null,
        },
        {
          ...
          status: 'blocked',
          purpose: 'Run all maintenance tools in read-only mode against restored staging data.',
          scope: [
        ...
        },
        {
          ...
          status: 'blocked',
          purpose: 'Verify every maintenance write path safely against restored staging data.',
          scope: [
            'Create a fresh backup or resettable staging copy.',
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          title: 'Add an upload incentive banner',
          status: 'planned',
          purpose: 'Encourage users to contribute campground and campsite media.',
          scope: [
            'Campaign/banner design.',
            'Administrator-controlled copy or source-controlled campaign configuration.',
            'Prize-draw wording and eligibility review.',
            'Analytics events.',
          ],
          notIncluded: [
            'Implementing a legal contest without reviewed terms.',
            'Changing upload quotas.',
          ],
          dependencies: [
            'Administrator-dashboard redesign or an agreed simpler placement.',
            'Campaign details.',
          ],
          doneWhen: [
            'Approved campaign is visible.',
            'Behavior and analytics are tested.',
            'Terms are linked where required.',
          ],
          notes: [],
          completedOn: null,
        },
